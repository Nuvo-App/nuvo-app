...
class NuvoVisualTheme extends ThemeExtension<NuvoVisualTheme> {
  ...
  static const trackside = NuvoVisualTheme(
    ...
    action: Color(0xFF327BFF),
    accent: Color(0xFF327BFF),
    secondaryAccent: Color(0xFF8D98A8),
    navigation: Color(0xFF07152C),
    onNavigation: Color(0xFFF7F9FC),
    hero: Color(0xFF07152C),
  ...
  static const crewMomentum = NuvoVisualTheme(
    ...
    mutedInk: Color(0xFF6F776F),
    border: Color(0xFFE1DDD5),
    action: Color(0xFF176BEE),
    accent: Color(0xFFBF765F),
    secondaryAccent: Color(0xFF78917A),
    navigation: Color(0xFFFFFEFC),
    onNavigation: Color(0xFF0A1930),
    hero: Color(0xFFFFFEFC),
    onHero: Color(0xFF0A1930),
    cardRadius: 20,
    heroRadius: 28,
    darkHero: false,
    floatingNavigation: false,
