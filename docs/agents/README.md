...
| [`15-crew-system-plan.md`](15-crew-system-plan.md) | **SUPERSEDED by 19** (design rationale only) — the crew connection graph, request/accept lifecycle, privacy, crew leaderboard; Squads sketched as a follow-on. |
| [`16-notification-system-plan.md`](16-notification-system-plan.md) | **SUPERSEDED by 19** (design rationale only) — notification categories & triggers, `notifications` table, `emitNotification`, FCM, preferences, rate limits, in-app centre. |
