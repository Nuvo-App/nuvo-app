...
WHERE user_id IN (
  SELECT id FROM users WHERE primary_email IN ('team@getnuvo.net', 'testing@getnuvo.net')
...
WHERE provider = 'reviewer' AND provider_user_id = 'team@getnuvo.net';
...
WHERE email IN ('team@getnuvo.net', 'testing@getnuvo.net');
...
WHERE primary_email = 'testing@getnuvo.net'
   OR id IN ('review-crew-riley', 'review-crew-maya', 'review-crew-jules');
...
SELECT
  'review-user-google', 'team@getnuvo.net', 'active',
  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP, 0, NULL, NULL
WHERE NOT EXISTS (
  SELECT 1 FROM users WHERE primary_email = 'team@getnuvo.net'
);
...
WHERE primary_email = 'team@getnuvo.net';
...
SELECT
  (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'),
  'Nuvo Review', 'nuvoreview', NULL, NULL, 0, 1, 0,
  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (
  SELECT 1 FROM profiles
  WHERE user_id = (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net')
);
...
VALUES
  ('review-person-google', 'review-person-google', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'Nuvo Review', 'nuvoreview-person', NULL, NULL, 'Reviewer account for app-store access.', 1, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
  ('review-crew-link-001', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'review-crew-riley', 'active', CURRENT_TIMESTAMP),
  ('review-crew-link-002', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'review-crew-maya', 'active', CURRENT_TIMESTAMP),
  ('review-crew-link-003', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'review-crew-jules', 'active', CURRENT_TIMESTAMP),
  ('review-crew-link-004', 'review-crew-riley', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'active', CURRENT_TIMESTAMP),
  ('review-crew-link-005', 'review-crew-maya', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'active', CURRENT_TIMESTAMP),
  ('review-crew-link-006', 'review-crew-jules', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'active', CURRENT_TIMESTAMP);
...
VALUES
  ('review-rm-001', 'review-race-pushups', 'review-person-google', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'owner', 'active', 'creator', 'active', datetime('now', '-2 days'), 'Nuvo Review', NULL),
  ...
  ('review-rm-005', 'review-race-squats', 'review-person-google', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'member', 'active', 'racer', 'active', datetime('now', '-1 day'), 'Nuvo Review', NULL),
  ...
  ('review-rm-008', 'review-race-plank', 'review-person-google', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'member', 'active', 'racer', 'active', datetime('now', '-8 days'), 'Nuvo Review', NULL),
  ...
  ('review-rm-010', 'review-race-lunges', 'review-person-google', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'owner', 'active', 'creator', 'active', datetime('now'), 'Nuvo Review', NULL);
...
VALUES
  ('review-rp-001', 'review-race-pushups', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 68, 68, NULL, 2, CURRENT_TIMESTAMP),
  ...
  ('review-rp-005', 'review-race-squats', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 28, 46, NULL, 2, CURRENT_TIMESTAMP),
  ...
  ('review-rp-008', 'review-race-plank', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 300, 100, datetime('now', '-1 day'), 1, CURRENT_TIMESTAMP),
  ('review-rp-009', 'review-race-plank', 'review-crew-riley', 190, 63, NULL, 3, CURRENT_TIMESTAMP),
  ('review-rp-010', 'review-race-lunges', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 0, 0, NULL, 1, CURRENT_TIMESTAMP);
...
VALUES
  ('review-move-001', 'review-race-pushups', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'movecheck', 'push_ups', 'push_ups', 'reps', 22, 'reps',
  ...
  ('review-move-003', 'review-race-squats', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'movecheck', 'squats', 'squats', 'reps', 28, 'reps',
  ...
  ('review-move-004', 'review-race-plank', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'movecheck', 'plank_hold', 'plank_hold', 'seconds', 60, 'seconds',
...
VALUES
  ('review-rfs-001', 'review-race-plank', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 1, 300, datetime('now', '-1 day'), CURRENT_TIMESTAMP),
...
VALUES
  ('review-invite-001', 'review-race-pushups', (SELECT id FROM users WHERE primary_email = 'team@getnuvo.net'), 'NUV-GOOGLE', 'active', datetime('now', '+30 days'), CURRENT_TIMESTAMP),
